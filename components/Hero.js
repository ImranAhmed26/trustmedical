      ...
      <ScrollAnimationWrapper>
        ...
        >
          <div className=' flex flex-col justify-center items-start row-start-2 sm:row-start-1'>
            <h1 className='text-3xl lg:text-4xl xl:text-6xl font-bold text-center text-green-500 leading-normal'>
             TRUST MEDICAL SERVICE
            </h1>
            <p className='text-black-500 text-xl mt-4 mb-6 text-center'>
            Transforming our Healthcare Industry Through Cutting-Edge Medical Equipment Solutions</p>
